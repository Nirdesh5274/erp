...
export default function AdminStudentsPage() {
  ...
  if (!isSchool) return <CollegeStudentsFallback />;
    ...
    <div className="space-y-6">
      <SectionCard title="Students" description="Manage confirmed and active students">
        <div className="mb-4 flex flex-wrap gap-2">
          <button onClick={() => setError("Use Enquiries page for new admissions. This page manages existing students.")} className="rounded-xl bg-teal-700 px-4 py-2 text-sm font-semibold text-white">+ Add Student</button>
                        ...
                        <select
                          ...
                          onChange={(event) => {
                            ...
                            if (action === "deactivate") {
                              ...
                              setError("View fee history shortcut is not wired yet. Use Fees page for now.");
                            } else if (action === "edit") {
                              setError("Edit details panel will be added next. Current flow supports status and password actions.");
                            }
...
function CollegeStudentsFallback() {
  return (
    <SectionCard title="Students" description="College student management continues on existing APIs.">
      <p className="text-sm text-slate-600">
        College workflow is unchanged. Use current students, admissions, and semester promotion flows.
      </p>
    </SectionCard>
  );
}
