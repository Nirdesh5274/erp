...
export default function HodAdmissionsPage() {
  ...
  const handleCreate = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const message = submitError instanceof Error ? submitError.message : "Unable to create admission";
      setError(message);
      toast.error(message);
    }
  };
  ...
  return (
    <div className="space-y-6">
      <SectionCard title="Add Student" description={isSchool ? "HOD can admit students in assigned class/section" : "HOD can admit students in own department"}>
      ...
      <SectionCard title="Recent Admissions" description="Department pipeline view">
